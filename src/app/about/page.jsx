...
export default function About() {
  return (
    <div className="max-w-6xl mx-auto space-y-4 p-4">
      <h1 className="font-medium text-amber-500 text-2xl">About</h1>
      <p>
      ...
      <p>
        At our movie database website, we are dedicated to bringing you the best
        possible movie-watching experience. Whether you are a casual viewer or a
        hardcore film buff, you will find everything you need to satisfy your
        cravings for great cinema. Our website is designed to be easy to
        navigate, with intuitive search tools and helpful filters that make it
        simple to find the movies you want to watch. And with our constantly
        updated database, you will always be up-to-date on the latest releases
        and hottest trends in the movie industry. But our website is more than
        just a place to find and watch movies. It is also a community of
        passionate movie lovers, sharing their thoughts and opinions on the
        films they love. From lively discussions to in-depth reviews, our forum
        is the perfect place to connect with like-minded individuals and explore
        the world of cinema together. So whether you are in the mood for a
        classic Hollywood blockbuster or an indie art film, we have got you
        covered. Visit our movie database website today and start exploring the
